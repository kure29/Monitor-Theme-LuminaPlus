...
const DESKTOP_OVERRIDE_KEY = "monitor-luminaplus:node-view-mode-session:desktop";
const MOBILE_OVERRIDE_KEY = "monitor-luminaplus:node-view-mode-session:mobile";
