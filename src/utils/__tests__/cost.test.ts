...
import type { NodeInfo } from "@/types/models";
...
describe("cost helpers", () => {
  ...
  it("can bypass a fresh exchange-rate cache for manual refresh", async () => {
    ...
    const key = `monitor-luminaplus:cost-rates:${url}`;
