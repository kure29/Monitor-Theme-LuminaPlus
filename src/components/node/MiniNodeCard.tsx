...
import type { NodeInfo, NodeMetrics, PingOverviewItem, PingOverviewBucket } from "@/types/models";
...
// 左栏集中显示实时速率，右栏集中显示本月流量；每栏均按上行、下行排列。
function MiniFlow({
  node,
  upRate,
  downRate,
  ...
  return (
    <div className="mini-node-flow">
      ...
      <div className="mini-node-flow-group" aria-label="本月流量">
        <MiniFlowRow
